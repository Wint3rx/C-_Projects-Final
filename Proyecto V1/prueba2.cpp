...
int main()
{
int a,b, num1,num2,num3,num4, num5, num6, num7, num8, op;
op=1;
char nombre[40], apellido[40], fecha[40], correo[40], puesto[40];
while (op==1)
{
system("cls");
cout<<"\n***********************************************************************************************************************"<<endl;
cout<<"\t\t\t\t\tBienvenidos a EMPRESA EL SUPER INGENIERO"<<endl;
cout<<"\t\t\t\t\t\t\tJutiapa,Jutiapa"<<endl;
cout<<"\n***********************************************************************************************************************"<<endl;
cout<<"\n\n\t1)-Registro de Empleados"<<endl;
cout<<"\t2)-Ventas por empleado"<<endl;
...
cin>>num7;
if (num7==1){
cout<<"El puesto es: Administrador con salario de Q5000\n";}
...
switch (opc2)
{
char empleadodepa[40], empleadomuni[40], aldea[40];
int op3;
case 1:
...
cout<<"Ingrese su fecha de Nacimiento: ";cin>>fecha;
cout<<"Ingrese su edad: "; cin>>num5;
cout<<"Años de laborar en la empresa: "; cin>>num6;
cout<<"Ingrese el correo electrónico: "; cin>>correo;
break;
}
case 2:
{
...
case 3:
{
float dig1,dig2,n3, sal1, sal2,sal3,sal4,sal5, 
bon1,bon2,bon3,bon4,bon5, bol1,bol2,bol3,bol4,bol5, 
com1,com2,com3,com4,com5, sueldo1, sueldo2, sueldo3, sueldo4, sueldo5;
sal1=5000; sal2=3000; sal3=2000; sal4=2000; sal5=1000; bon1=500; 
bon2=300; bon3=250; bon4=250; bon5=250; bol1=50; bol2=50; bol3=15; 
bol4=15; bol5=15;
float ig1,ig2,ig3,ig4,ig5, is1, is2, is3, is4, is5, 
irtra1,irtra2,irtra3,irtra4,irtra5;
ig1=sal1*.0483; ig2=sal2*.0483; ig3=sal3*.0483; ig4=sal4*.0483; 
ig5=sal5*.0483; is1=sal1*.0400, is2=sal2*.0400, is3=sal3*.0200, 
is4=sal4*.0200, is5=sal5*.0200; irtra1=sal1*0.01; irtra2=sal2*0.01; 
irtra3=sal3*0.01; irtra4=sal4*0.01; irtra5=sal5*0.01;
cout<<"3)-Nomina de sueldo\n";
cout<<"\n\n\tDatos de la Venta\n";
cout<<"Ingrese la cantidad del producto: "; cin>>dig1;
cout<<"Ingrese el precio del producto por unidad: Q"; 
cin>>dig2;
cout<<"\n\n\t\t\tNomina de Sueldos\n";
cout<<"\n\tPuesto"<<"\t\tSalario"<<"\t\tBonificacion"<<endl;
cout<<"Administrador"<<"\t\t"<<sal1<<"\t\t"<<bon1<<endl;
cout<<"Vendedor"<<"\t\t"<<sal2<<"\t\t"<<bon2<<endl;
cout<<"Auxiliar de Vendedor"<<"\t"<<sal3<<"\t\t"<<bon3<<endl;
cout<<"Encargado de Bodega"<<"\t"<<sal4<<"\t\t"<<bon4<<endl;
cout<<"Encargado de limpieza"<<"\t"<<sal5<<"\t\t"<<bon5<<endl;
sueldo1=(sal1+bon1)-(ig1+is1+irtra1+bol1);
sueldo2=(sal2+bon2)-(ig2+is2+irtra2+bol2);
sueldo3=(sal3+bon3)-(ig3+is3+irtra3+bol3);
sueldo4=(sal4+bon4)-(ig4+is4+irtra4+bol4);
sueldo5=(sal5+bon5)-(ig5+is5+irtra5+bol5);
cout<<"\n\t\t\tNomina General\n";
cout<<"\n\tPuesto"<<"\t\t\tIGSS"<<"\t\tBol. Ornato"<<"\tISR"<<"\tComisiones"<<"\tSueldo Liquido"<<endl;
cout<<"Administrador"<<"\t\t\t"<<ig1<<"\t\t"<<bol1<<"\t\t"<<is1<<"\t\t\t"<<sueldo1<<endl;
n3=dig1*dig2;
com1=n3*0.01;
com2=n3*0.03;
com3=n3*0.05;
...
com5=n3*0.09;
if ((n3>=0)&&(n3<=2000)){ 
cout<<"Vendedor"<<"\t\t\t"<<ig1<<"\t\t"<<bol1<<"\t\t"<<is1<<"\t"<<com1<<"\t\t"<<sueldo2<<endl;}
else if ((n3>=2001)&&(n3<=6000)){ 
cout<<"Vendedor"<<"\t\t\t"<<ig2<<"\t\t"<<bol2<<"\t\t"<<is2<<"\t"<<com2<<"\t\t"<<sueldo2<<endl;}
else if ((n3>=6001)&&(n3<=8000)){ 
cout<<"Vendedor"<<"\t\t\t"<<ig3<<"\t\t"<<bol3<<"\t\t"<<is3<<"\t"<<com3<<"\t\t"<<sueldo2<<endl;}
else if ((n3>=8001)&&(n3<=9000)){ 
cout<<"Vendedor"<<"\t\t\t"<<ig4<<"\t\t"<<bol4<<"\t\t"<<is4<<"\t"<<com4<<"\t\t"<<sueldo2<<endl;}
else if (n3>=9001){ 
cout<<"Vendedor"<<"\t\t\t"<<ig5<<"\t\t"<<bol5<<"\t\t"<<is5<<"\t"<<com5<<"\t\t"<<sueldo2<<endl;}
cout<<"Auxiliar de Vendedor"<<"\t\t"<<ig3<<"\t\t"<<bol3<<"\t\t"<<is3<<"\t\t\t"<<sueldo3<<endl;
cout<<"Encargado de Bodega"<<"\t\t"<<ig4<<"\t\t"<<bol4<<"\t\t"<<is4<<"\t\t\t"<<sueldo4<<endl;
cout<<"Encargado de limpieza"<<"\t\t"<<ig5<<"\t\t"<<bol5<<"\t\t"<<is5<<"\t\t\t"<<sueldo5<<endl;
break;
}
case 4:
cout<<"\n\n\t5)-Reportes\n";
cout<<"\n\tPor favor seleccione una opcion\n";
cout<<"\n\t6)-Reporte de Datos Generales de los Empleados\n";
cout<<"\t7)-Reporte de Nomina General de Empleados\n";
cout<<"\t8)-Reporte de Salarios\n";
cout<<"\t9)-Reporte por producto vendido\n";
cout<<"\t10)-Salir\n";
cin>>b;
switch (b)
{
...
cin>>num5;
cout<<"Ingrese el numero de celular del trabajo del Empleado\n";
cin>>num4;
cout<<"Ingrese el correo electronico del empleado\n";
cin>>correo;
cout<<"\n\n\tDatos Generales del empleado\n";
cout<<"El nombre es:"<<nombre<<endl; cout<<"El apellido es: "<<apellido<<endl; cout<<num7<<endl; 
cout<<"La direccion es: "<<puesto<<endl; cout<<"La edad del empleado es: "<<num5<<endl; cout<<"El numero telefonico es: "<<num4<<endl; 
cout<<"El correo electronico es: "<<correo<<endl;
break;
case 6:
{
int dig1,dig2, n3, sal1, sal2,sal3,sal4,sal5, 
bon1,bon2,bon3,bon4,bon5, bol1,bol2,bol3,bol4,bol5;
sal1=5000; sal2=3000; sal3=2000; sal4=2000; sal5=1000; 
bon1=500; bon2=300; bon3=250; bon4=250; bon5=250; bol1=50; bol2=50; 
bol3=15; bol4=15; bol5=15;
float ig1,ig2,ig3,ig4,ig5, is1, is2, is3, is4, 
is5,com1,com2,com3,com4,com5, irtra1,irtra2,irtra3,irtra4,irtra5, sueldo1, 
sueldo2, sueldo3, sueldo4, sueldo5;
ig1=sal1*.0483; ig2=sal2*.0483; ig3=sal3*.0483; 
ig4=sal4*.0483; ig5=sal5*.0483; is1=sal1*.0400, is2=sal2*.0400, 
is3=sal3*.0200, is4=sal4*.0200, is5=sal5*.0200; irtra1=sal1*0.01; 
irtra2=sal2*0.01; irtra3=sal3*0.01; irtra4=sal4*0.01; irtra5=sal5*0.01;
cout<<"\n\n\tDatos de la Venta\n";
cout<<"Ingrese la cantidad del producto: "; cin>>dig1;
cout<<"Ingrese el precio del producto por unidad: Q"; 
cin>>dig2;
sueldo1=(sal1+bon1)-(ig1+is1+irtra1+bol1);
cout<<"\n\n**Nomina General**\n";
cout<<"\n\tPuesto"<<"\t\tIGSS"<<"\tBol. Ornato"<<"\tISR"<<"\tIRTRA"<<"\tComisiones"<<"\tSueldo Liquido"<<endl;
cout<<"Administrador"<<"\t\t"<<ig1<<"\t"<<bol1<<"\t\t"<<is1<<"\t"<<irtra1<<"\t\t\t"<<sueldo1<<endl;
n3=dig1*dig2;
com1=n3*0.01;
com2=n3*0.03;
com3=n3*0.05;
...
cout<<"Vendedor"<<"\t\t"<<ig2<<"\t"<<bol2<<"\t\t"<<is2<<"\t"<<irtra2<<"\t"<<com2<<"\t\t"<<sueldo2<<endl;}
else if ((n3>=6001)&&(n3<=8000)){ 
cout<<"Vendedor"<<"\t\t"<<ig3<<"\t"<<bol3<<"\t\t"<<is3<<"\t"<<com3<<"\t\t"<<sueldo2<<endl;}
else if ((n3>=8001)&&(n3<=9000)){ 
cout<<"Vendedor"<<"\t\t"<<ig4<<"\t"<<bol4<<"\t\t"<<is4<<"\t"<<com4<<"\t\t"<<sueldo2<<endl;}
...
cout<<"Vendedor"<<"\t\t"<<ig5<<"\t"<<bol5<<"\t\t"<<is5<<"\t"<<com5<<"\t\t"<<sueldo2<<endl;}
cout<<"Aux.de Vendedor"<<"\t\t"<<ig3<<"\t"<<bol3<<"\t\t"<<is3<<"\t"<<irtra3<<"\t\t\t"<<sueldo1<<endl;
cout<<"Encar. de Bodega"<<"\t"<<ig4<<"\t"<<bol4<<"\t\t"<<is4<<"\t"<<irtra4<<"\t\t\t"<<sueldo1<<endl;
cout<<"Encar. de limpieza"<<"\t"<<ig5<<"\t"<<bol5<<"\t\t"<<is5<<"\t"<<irtra5<<"\t\t\t"<<sueldo1<<endl;
break;
}
case 7:
{
int sal1, sal2,sal3,sal4,sal5, bon1,bon2,bon3,bon4,bon5;
sal1=5000; sal2=3000; sal3=2000; sal4=2000; sal5=1000; 
bon1=500; bon2=300; bon3=250; bon4=250; bon5=250;
cout<<"\t\t\tNomina de Sueldos\n";
cout<<"\n\tPuesto"<<"\t\tSalario"<<"\t\tBonificacion"<<endl
;
cout<<"Administrador"<<"\t\t"<<sal1<<"\t\t"<<bon1<<endl;
cout<<"Vendedor"<<"\t\t"<<sal2<<"\t\t"<<bon2<<endl;
...
char descrip[40];
int dig1,dig2,n3;
float com1,com2,com3,com4,com5;
cout<<"Ingrese la descripcion del producto: "; 
cin>>descrip;
cout<<"Ingrese la cantidad del producto: "; cin>>dig1;
cout<<"Ingrse el precio del producto por unidad: Q"; 
cin>>dig2;
n3=dig1*dig2;
com1=n3*0.01;
com2=n3*0.03;
...
com4=n3*0.07;
com5=n3*0.09;
cout<<"El precio final del producto es Q"<<n3<<endl;
if ((n3>=0)&&(n3<=2000)){ cout<<"La comision del Vendedor es: Q"<<com1<<endl;}
else if ((n3>=2001)&&(n3<=6000)){ cout<<"La comision del Vendedor es: Q"<<com2<<endl;}
else if ((n3>=6001)&&(n3<=8000)){ cout<<"La comision del Vendedor es: Q"<<com3<<endl;}
else if ((n3>=8001)&&(n3<=9000)){ cout<<"La comision del Vendedor es: Q"<<com4<<endl;}
else if (n3>=9001){ cout<<"La comision del Vendedor es: Q"<<com5<<endl;}
break;
}
case 9:
{
cout<<"\t\t\t\t**Gracias por usar este programa!!**\n";
cout<<"\t\t\t\t\tTenga un lindo dia :)\n";
cout<<"\n\n\t\t\t\tJose Miguel Guerra Hernandez\n";
cout<<"\t\t\t\tLuis Gerardo Guerra Hernandez\n";
cout<<"\t\t\t\tWilly Alexander Villanueva Lima\n";
system("pause");
return 0;
break;
}
...
break;
default:
cout<<"La opcion que ha ingresado es incorrecta\n";
break;
}
